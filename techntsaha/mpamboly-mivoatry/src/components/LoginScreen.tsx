              ...
              <View className="flex-row items-start justify-between gap-2">
                <View className="flex-row items-center gap-2.5 flex-1">
                  <View className="w-12 h-12 rounded-2xl bg-white/20 items-center justify-center border border-white/30">
                    {React.cloneElement(currentSlide.icon as React.ReactElement, { className: 'w-6 h-6 text-white' })}
                  </View>
              ...
              {roleSlides.slice(0, 4).map((slide) => (
                ...
                >
                  <View className="p-1 rounded-lg bg-[#F5F2EB]">
                    {React.cloneElement(slide.icon as React.ReactElement, { className: 'w-3.5 h-3.5 text-brand-brown' })}
                  </View>
                  <View className="flex-1">
